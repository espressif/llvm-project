...
// MCPU-ESP8266: "-target-feature" "+debug" "-target-feature" "+exception" "-target-feature" "+highpriinterrupts" "-target-feature" "+highpriinterruptslevel3"
...
// MCPU-ESP32: "-target-feature" "+highpriinterrupts" "-target-feature" "+highpriinterruptslevel7" "-target-feature" "+coprocessor"
...
// MCPU-ESP32S2: "-target-feature" "+debug" "-target-feature" "+exception" "-target-feature" "+highpriinterrupts" "-target-feature" "+highpriinterruptslevel7"
...
// MCPU-ESP32S3: "-target-feature" "+highpriinterrupts" "-target-feature" "+highpriinterruptslevel7" "-target-feature" "+coprocessor"
