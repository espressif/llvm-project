...
// CHECK-NEXT:    [[BYVAL_TEMP:%.*]] = alloca <8 x i16>, align 16
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 16, ptr nonnull [[BYVAL_TEMP]]) #[[ATTR7:[0-9]+]]
// CHECK-NEXT:    store <8 x i16> [[TMP3]], ptr [[BYVAL_TEMP]], align 16, !tbaa [[TBAA9:![0-9]+]]
// CHECK-NEXT:    call void @esp_vec128_16_to_8(ptr dead_on_unwind nonnull writable sret(<16 x i8>) align 16 [[TMP]], ptr noundef nonnull [[BYVAL_TEMP]]) #[[ATTR7]]
// CHECK-NEXT:    [[TMP4:%.*]] = load <16 x i8>, ptr [[TMP]], align 16, !tbaa [[TBAA9]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 16, ptr nonnull [[BYVAL_TEMP]]) #[[ATTR7]]
// CHECK-NEXT:    [[TMP5:%.*]] = call ptr @llvm.riscv.esp.vst.128.ip.m(<16 x i8> [[TMP4]], ptr [[DST]], i32 16)
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr noundef [[SRC1:%.*]], ptr noundef [[SRC2:%.*]], ptr noundef [[DST:%.*]], i32 noundef [[SHIFT:%.*]]) local_unnamed_addr #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 16, ptr nonnull [[BYVAL_TEMP]]) #[[ATTR7]]
// CHECK-NEXT:    store <8 x i16> [[TMP6]], ptr [[BYVAL_TEMP]], align 16, !tbaa [[TBAA9]]
// CHECK-NEXT:    call void @esp_vec128_16_to_8(ptr dead_on_unwind nonnull writable sret(<16 x i8>) align 16 [[TMP]], ptr noundef nonnull [[BYVAL_TEMP]]) #[[ATTR7]]
// CHECK-NEXT:    [[TMP7:%.*]] = load <16 x i8>, ptr [[TMP]], align 16, !tbaa [[TBAA9]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 16, ptr nonnull [[BYVAL_TEMP]]) #[[ATTR7]]
// CHECK-NEXT:    [[TMP8:%.*]] = call ptr @llvm.riscv.esp.vst.128.ip.m(<16 x i8> [[TMP7]], ptr [[DST]], i32 16)
// CHECK-NEXT:    ret void
//
