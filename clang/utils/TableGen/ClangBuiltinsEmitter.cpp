  ...
  void ParseType(StringRef T) {
    ...
    if (T.consume_back("*")) {
      ...
      auto ReturnTypeVal = StringSwitch<std::string>(T)
                               ...
                               .Case("__rvm_int8_t", "Qm0")
                               .Case("__rvm_int16_t", "Qm1")
                               .Case("__rvm_int32_t", "Qm2")
                               .Case("__rvm_int64_t", "Qm3")
                               .Case("__rvm_uint8_t", "Qm4")
                               .Case("__rvm_uint16_t", "Qm5")
                               .Case("__rvm_uint32_t", "Qm6")
                               .Case("__rvm_uint64_t", "Qm7")
                               .Case("__rvm_float16_t", "Qm8")
                               .Case("__rvm_float32_t", "Qm9")
                               .Case("__rvm_float64_t", "Qm10")
                               .Case("__rvm_int8x2_t", "Qm11")
                               .Case("__rvm_int16x2_t", "Qm12")
                               .Case("__rvm_int32x2_t", "Qm13")
                               .Case("__rvm_int64x2_t", "Qm14")
                               .Case("__rvm_uint8x2_t", "Qm15")
                               .Case("__rvm_uint16x2_t", "Qm16")
                               .Case("__rvm_uint32x2_t", "Qm17")
                               .Case("__rvm_uint64x2_t", "Qm18")
                               .Case("__rvm_float16x2_t", "Qm19")
                               .Case("__rvm_float32x2_t", "Qm20")
                               .Case("__rvm_float64x2_t", "Qm21")
