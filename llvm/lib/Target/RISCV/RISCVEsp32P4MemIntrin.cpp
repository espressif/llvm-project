...
Value *RISCVEsp32P4MemIntrin::createEspVld128Ip(IRBuilder<> &Builder,
  ...
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vld_128_ip, {});
...
Value *RISCVEsp32P4MemIntrin::createEspVldH64Ip(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vld_h_64_ip, {});
  return Builder.CreateCall(
      IntrinsicFunc,
...
Value *RISCVEsp32P4MemIntrin::createEspVldL64Ip(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vld_l_64_ip, {});
  return Builder.CreateCall(
      IntrinsicFunc,
      {src, ConstantInt::get(i32Ty, 8), ConstantInt::get(i32Ty, index)},
      "vldl64ip");
...
Value *RISCVEsp32P4MemIntrin::createEspVst128Ip(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vst_128_ip, {});
  return Builder.CreateCall(
      IntrinsicFunc,
...
Value *RISCVEsp32P4MemIntrin::createEspVstH64Ip(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vst_h_64_ip, {});
  return Builder.CreateCall(
      IntrinsicFunc,
...
Value *RISCVEsp32P4MemIntrin::createEspVstL64Ip(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_vst_l_64_ip, {});
  return Builder.CreateCall(
      IntrinsicFunc,
      {ConstantInt::get(i32Ty, index), dst, ConstantInt::get(i32Ty, 8)},
      "vstl64ip");
...
Value *RISCVEsp32P4MemIntrin::createEspSrcQLdIp(IRBuilder<> &Builder,
  ...
  Type *i32Ty = Builder.getInt32Ty();
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_src_q_ld_ip, {});
...
void inline RISCVEsp32P4MemIntrin::createEspSrcQ(IRBuilder<> &Builder,
  ...
  Function *IntrinsicFunc =
      Intrinsic::getDeclarationIfExists(module, Intrinsic::riscv_esp_src_q);
  Type *i32Ty = Builder.getInt32Ty();
