...
; CHECK-NEXT:    [[ACC_079_US:%.*]] = phi i64 [ [[ADD_US_RELOAD_GENERIC:%.*]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]] ], [ 0, %[[FOR_COND25_PREHEADER_US_PREHEADER]] ]
...
; CHECK-NEXT:    [[ACC_0_LCSSA:%.*]] = phi i64 [ 0, %[[IF_END16]] ], [ [[ADD_US_RELOAD_GENERIC]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]] ]
