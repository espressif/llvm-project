...
; NOTE: movx *.fft.bit.width.m intrinsics lower with +xespv1v only (ESPV 2.1).
; ESPV 2.2 (+xespv) uses separate .2p2 movx intrinsics; see xespv2p2.ll.
; The fft.bitrev 2.1 vs 2.2 opcode fix (!419) is in RISCVISelDAGToDAG.cpp.
