...
source_filename = "./riscv-esp32p4-load-store-1.c"
...
; Function Attrs: nounwind memory(read, argmem: readwrite, inaccessiblemem: none)
...
attributes #1 = { nofree nounwind memory(argmem: read) }
attributes #2 = { nounwind memory(read, argmem: readwrite, inaccessiblemem: none) }
