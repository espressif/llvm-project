...
; CHECK-NEXT:    [[ARRAYIDX_FAST:%.*]] = getelementptr inbounds i16, ptr [[INPUT]], i32 [[I_016_FAST]]
; CHECK-NEXT:    [[TMP23:%.*]] = load i16, ptr [[ARRAYIDX_FAST]], align 2, !tbaa [[TBAA6:![0-9]+]]
...
; CHECK-NEXT:    [[ARRAYIDX9_FAST:%.*]] = getelementptr inbounds i16, ptr [[OUTPUT]], i32 [[I_016_FAST]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !tbaa [[TBAA6]]
