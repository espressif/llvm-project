...
; CHECK-NEXT:    [[ARRAYIDX_FAST:%.*]] = getelementptr inbounds i8, ptr [[INPUT1]], i32 [[I_023_FAST]]
; CHECK-NEXT:    [[TMP25:%.*]] = load i8, ptr [[ARRAYIDX_FAST]], align 1, !tbaa [[TBAA6:![0-9]+]]
; CHECK-NEXT:    [[CONV_FAST:%.*]] = sext i8 [[TMP25]] to i32
; CHECK-NEXT:    [[ARRAYIDX9_FAST:%.*]] = getelementptr inbounds i8, ptr [[INPUT2]], i32 [[I_023_FAST]]
; CHECK-NEXT:    [[TMP26:%.*]] = load i8, ptr [[ARRAYIDX9_FAST]], align 1, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    [[ARRAYIDX13_FAST:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT]], i32 [[I_023_FAST]]
...
; CHECK-NEXT:    [[TMP27:%.*]] = load i8, ptr [[ARRAYIDX]], align 1, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    [[TMP28:%.*]] = load i8, ptr [[ARRAYIDX9]], align 1, !tbaa [[TBAA6]]
