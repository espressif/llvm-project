...
; CHECK-NEXT:    [[TMP2:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !tbaa [[TBAA6:![0-9]+]]
; CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP2]] to i32
; CHECK-NEXT:    [[MUL6:%.*]] = mul nsw i32 [[CONV]], [[CONV5_FAST]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT]], label %[[RETURN_LOOPEXIT:.*]], label %[[FOR_BODY]], !llvm.loop [[LOOP10:![0-9]+]]
