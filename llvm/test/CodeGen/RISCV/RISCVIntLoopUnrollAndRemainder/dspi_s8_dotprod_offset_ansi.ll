...
; CHECK-SAME: ptr nocapture noundef readonly [[IN_IMAGE:%.*]], ptr nocapture noundef readonly [[FILTER:%.*]], ptr nocapture noundef writeonly [[OUT_VALUE:%.*]], i32 noundef [[COUNT_X:%.*]], i32 noundef [[COUNT_Y:%.*]], i32 noundef [[SHIFT:%.*]], i8 noundef signext [[OFFSET:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    br i1 [[CMP2676]], label [[FOR_BODY28:%.*]], label [[FOR_COND_CLEANUP27]]
...
; CHECK-NEXT:    [[TMP30]] = phi i32 [ [[ACC_082]], [[FOR_COND25_PREHEADER]] ], [ [[ADD40_CLONE:%.*]], [[FOR_BODY28]] ]
...
; CHECK:       for.body28:
; CHECK-NEXT:    [[X_078_CLONE:%.*]] = phi i32 [ [[INC_CLONE:%.*]], [[FOR_BODY28]] ], [ 0, [[FOR_COND25_PREHEADER]] ]
; CHECK-NEXT:    [[ACC_177_CLONE:%.*]] = phi i32 [ [[ADD40_CLONE]], [[FOR_BODY28]] ], [ [[ACC_082]], [[FOR_COND25_PREHEADER]] ]
