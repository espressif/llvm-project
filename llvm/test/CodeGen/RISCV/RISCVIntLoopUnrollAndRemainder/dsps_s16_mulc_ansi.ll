...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL]]
...
; CHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8]]
...
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_1]]
...
; CHECK-NEXT:    [[ARRAYIDX9_1:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_1]]
...
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_2]]
...
; CHECK-NEXT:    [[ARRAYIDX9_2:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_2]]
...
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_3]]
...
; CHECK-NEXT:    [[ARRAYIDX9_3:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_3]]
...
; CHECK-NEXT:    [[ARRAYIDX_4:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_4]]
...
; CHECK-NEXT:    [[ARRAYIDX9_4:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_4]]
...
; CHECK-NEXT:    [[ARRAYIDX_5:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_5]]
...
; CHECK-NEXT:    [[ARRAYIDX9_5:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_5]]
...
; CHECK-NEXT:    [[ARRAYIDX_6:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_6]]
...
; CHECK-NEXT:    [[ARRAYIDX9_6:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_6]]
...
; CHECK-NEXT:    [[ARRAYIDX_7:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_7]]
...
; CHECK-NEXT:    [[ARRAYIDX9_7:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_7]]
...
; CHECK-NEXT:    [[ARRAYIDX_8:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_8]]
...
; CHECK-NEXT:    [[ARRAYIDX9_8:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_8]]
...
; CHECK-NEXT:    [[ARRAYIDX_9:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_9]]
...
; CHECK-NEXT:    [[ARRAYIDX9_9:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_9]]
...
; CHECK-NEXT:    [[ARRAYIDX_10:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_10]]
...
; CHECK-NEXT:    [[ARRAYIDX9_10:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_10]]
...
; CHECK-NEXT:    [[ARRAYIDX_11:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_11]]
...
; CHECK-NEXT:    [[ARRAYIDX9_11:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_11]]
...
; CHECK-NEXT:    [[ARRAYIDX_12:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_12]]
...
; CHECK-NEXT:    [[ARRAYIDX9_12:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_12]]
...
; CHECK-NEXT:    [[ARRAYIDX_13:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_13]]
...
; CHECK-NEXT:    [[ARRAYIDX9_13:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_13]]
...
; CHECK-NEXT:    [[ARRAYIDX_14:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_14]]
...
; CHECK-NEXT:    [[ARRAYIDX9_14:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_14]]
...
; CHECK-NEXT:    [[ARRAYIDX_15:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_15]]
...
; CHECK-NEXT:    [[ARRAYIDX9_15:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_15]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds [2 x i8], ptr [[INPUT]], i32 [[MUL_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX9_CLONE:%.*]] = getelementptr inbounds [2 x i8], ptr [[OUTPUT]], i32 [[MUL8_CLONE]]
