...
; CHECK-NEXT:    [[TMP4:%.*]] = load i16, ptr [[COEFFS_LEN]], align 4
; CHECK-NEXT:    [[DELAY:%.*]] = getelementptr inbounds [[STRUCT_FIR_S16_S]], ptr [[FIR]], i32 0, i32 1
; CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[DELAY]], align 4
...
; CHECK-NEXT:    [[TMP6:%.*]] = load i16, ptr [[D_POS]], align 2
; CHECK-NEXT:    [[CMP18138:%.*]] = icmp sgt i16 [[TMP3]], [[TMP6]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = load i16, ptr [[POS]], align 2
; CHECK-NEXT:    [[CONV39:%.*]] = sext i16 [[TMP7]] to i32
; CHECK-NEXT:    [[CONV42:%.*]] = sext i16 [[TMP4]] to i32
; CHECK-NEXT:    [[COEFF_POS_0141:%.*]] = add i16 [[TMP4]], -1
; CHECK-NEXT:    [[CMP43142:%.*]] = icmp slt i16 [[TMP7]], [[TMP4]]
...
; CHECK-NEXT:    br label [[FOR_BODY46_CLONE:%.*]]
; CHECK:       for.body21:
; CHECK-NEXT:    [[J_0140:%.*]] = phi i32 [ 0, [[FOR_COND14_PREHEADER_FOR_BODY21_CRIT_EDGE]] ], [ [[INC32:%.*]], [[IF_END28]] ]
; CHECK-NEXT:    [[INPUT_POS_1139:%.*]] = phi i32 [ [[INPUT_POS_0154]], [[FOR_COND14_PREHEADER_FOR_BODY21_CRIT_EDGE]] ], [ [[INC]], [[IF_END28]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = load i16, ptr [[POS]], align 2
; CHECK-NEXT:    [[CMP24_NOT:%.*]] = icmp slt i16 [[TMP8]], [[TMP4]]
...
; CHECK-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds i16, ptr [[TMP5]], i32 [[IDXPROM]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = add i16 [[TMP7]], -1
; CHECK-NEXT:    br label [[FOR_COND58_PREHEADER]]
; CHECK:       for.cond58.preheader:
; CHECK-NEXT:    [[ACC_0_LCSSA:%.*]] = phi i64 [ [[ROUNDING_0]], [[FOR_COND_CLEANUP20]] ], [ [[ADD_CLONE:%.*]], [[FOR_COND227_PREHEADER_LOOPEXIT:%.*]] ]
; CHECK-NEXT:    [[COEFF_POS_0_LCSSA:%.*]] = phi i16 [ [[COEFF_POS_0141]], [[FOR_COND_CLEANUP20]] ], [ [[TMP12]], [[FOR_COND227_PREHEADER_LOOPEXIT]] ]
; CHECK-NEXT:    [[CMP61148:%.*]] = icmp sgt i16 [[TMP7]], 0
...
; CHECK:       for.body46:
; CHECK-NEXT:    [[COEFF_POS_0145_CLONE:%.*]] = phi i16 [ [[COEFF_POS_0141]], [[FOR_BODY46_15]] ], [ [[COEFF_POS_0_CLONE:%.*]], [[FOR_BODY46_CLONE]] ]
; CHECK-NEXT:    [[N_0144_CLONE:%.*]] = phi i32 [ [[CONV39]], [[FOR_BODY46_15]] ], [ [[INC55_CLONE:%.*]], [[FOR_BODY46_CLONE]] ]
; CHECK-NEXT:    [[ACC_0143_CLONE:%.*]] = phi i64 [ [[ROUNDING_0]], [[FOR_BODY46_15]] ], [ [[ADD_CLONE]], [[FOR_BODY46_CLONE]] ]
...
; CHECK-NEXT:    [[TMP14:%.*]] = load i16, ptr [[ARRAYIDX48_CLONE]], align 2
; CHECK-NEXT:    [[CONV49_CLONE:%.*]] = sext i16 [[TMP14]] to i32
; CHECK-NEXT:    [[ARRAYIDX51_CLONE:%.*]] = getelementptr inbounds i16, ptr [[TMP5]], i32 [[N_0144_CLONE]]
; CHECK-NEXT:    [[TMP15:%.*]] = load i16, ptr [[ARRAYIDX51_CLONE]], align 2
; CHECK-NEXT:    [[CONV52_CLONE:%.*]] = sext i16 [[TMP15]] to i32
...
; CHECK-NEXT:    [[ACC_1_LCSSA:%.*]] = phi i64 [ [[ACC_0_LCSSA]], [[FOR_COND58_PREHEADER]] ], [ [[ADD75_CLONE:%.*]], [[FOR_BODY64_15]] ]
...
; CHECK:       for.body64:
; CHECK-NEXT:    [[N57_0151_CLONE:%.*]] = phi i32 [ 0, [[FOR_BODY64_LR_PH]] ], [ [[INC77_CLONE:%.*]], [[FOR_BODY64_15]] ]
; CHECK-NEXT:    [[COEFF_POS_1150_CLONE:%.*]] = phi i16 [ [[COEFF_POS_0_LCSSA]], [[FOR_BODY64_LR_PH]] ], [ [[DEC66_CLONE:%.*]], [[FOR_BODY64_15]] ]
; CHECK-NEXT:    [[ACC_1149_CLONE:%.*]] = phi i64 [ [[ACC_0_LCSSA]], [[FOR_BODY64_LR_PH]] ], [ [[ADD75_CLONE]], [[FOR_BODY64_15]] ]
; CHECK-NEXT:    [[DEC66_CLONE]] = add i16 [[COEFF_POS_1150_CLONE]], -1
; CHECK-NEXT:    [[IDXPROM67:%.*]] = sext i16 [[COEFF_POS_1150_CLONE]] to i32
; CHECK-NEXT:    [[ARRAYIDX68:%.*]] = getelementptr inbounds i16, ptr [[TMP13]], i32 [[IDXPROM67]]
; CHECK-NEXT:    [[TMP17:%.*]] = load i16, ptr [[ARRAYIDX68]], align 2
; CHECK-NEXT:    [[CONV69_CLONE:%.*]] = sext i16 [[TMP17]] to i32
; CHECK-NEXT:    [[ARRAYIDX71_CLONE:%.*]] = getelementptr inbounds i16, ptr [[TMP5]], i32 [[N57_0151_CLONE]]
; CHECK-NEXT:    [[TMP18:%.*]] = load i16, ptr [[ARRAYIDX71_CLONE]], align 2
; CHECK-NEXT:    [[CONV72_CLONE:%.*]] = sext i16 [[TMP18]] to i32
...
; CHECK-NEXT:    br i1 [[EXITCOND159_NOT_CLONE]], label [[FOR_COND_CLEANUP63]], label [[FOR_BODY64_15]]
;
entry:
