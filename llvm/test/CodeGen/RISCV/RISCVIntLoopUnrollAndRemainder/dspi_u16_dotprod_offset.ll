...
; CHECK-SAME: ptr nocapture noundef readonly [[IN_IMAGE:%.*]], ptr nocapture noundef readonly [[FILTER:%.*]], ptr nocapture noundef writeonly [[OUT_VALUE:%.*]], i32 noundef [[COUNT_X:%.*]], i32 noundef [[COUNT_Y:%.*]], i32 noundef [[SHIFT:%.*]], i16 noundef zeroext [[OFFSET:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    br i1 [[CMP2675]], label [[FOR_BODY28:%.*]], label [[FOR_COND_CLEANUP27]]
...
; CHECK-NEXT:    [[TMP30]] = phi i64 [ [[ACC_081]], [[FOR_COND25_PREHEADER]] ], [ [[ADD38_CLONE:%.*]], [[FOR_BODY28]] ]
...
; CHECK:       for.body28:
; CHECK-NEXT:    [[X_077_CLONE:%.*]] = phi i32 [ [[INC_CLONE:%.*]], [[FOR_BODY28]] ], [ 0, [[FOR_COND25_PREHEADER]] ]
; CHECK-NEXT:    [[ACC_176_CLONE:%.*]] = phi i64 [ [[ADD38_CLONE]], [[FOR_BODY28]] ], [ [[ACC_081]], [[FOR_COND25_PREHEADER]] ]
