...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[I_07]]
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[I_07]]
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD]]
; CHECK-NEXT:    [[ARRAYIDX1_1:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD]]
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD9]]
; CHECK-NEXT:    [[ARRAYIDX1_2:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD9]]
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD11]]
; CHECK-NEXT:    [[ARRAYIDX1_3:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD11]]
; CHECK-NEXT:    [[ARRAYIDX_4:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX1_4:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX_5:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD15]]
; CHECK-NEXT:    [[ARRAYIDX1_5:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD15]]
; CHECK-NEXT:    [[ARRAYIDX_6:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD17]]
; CHECK-NEXT:    [[ARRAYIDX1_6:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD17]]
; CHECK-NEXT:    [[ARRAYIDX_7:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA1]], i32 [[ADD19]]
; CHECK-NEXT:    [[ARRAYIDX1_7:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[DATA2]], i32 [[ADD19]]
