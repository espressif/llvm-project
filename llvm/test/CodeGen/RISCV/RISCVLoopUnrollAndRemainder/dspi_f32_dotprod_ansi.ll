...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30]]
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[MUL32:%.*]] = mul nsw i32 [[X_067]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32]]
...
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_1]]
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX_1]], align 4
; CHECK-NEXT:    [[MUL32_1:%.*]] = mul nsw i32 [[INC]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_1:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_1]]
...
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_2]]
; CHECK-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX_2]], align 4
; CHECK-NEXT:    [[MUL32_2:%.*]] = mul nsw i32 [[INC_1]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_2:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_2]]
...
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_3]]
; CHECK-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX_3]], align 4
; CHECK-NEXT:    [[MUL32_3:%.*]] = mul nsw i32 [[INC_2]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_3:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_3]]
...
; CHECK-NEXT:    [[ARRAYIDX_4:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_4]]
; CHECK-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX_4]], align 4
; CHECK-NEXT:    [[MUL32_4:%.*]] = mul nsw i32 [[INC_3]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_4:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_4]]
...
; CHECK-NEXT:    [[ARRAYIDX_5:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_5]]
; CHECK-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX_5]], align 4
; CHECK-NEXT:    [[MUL32_5:%.*]] = mul nsw i32 [[INC_4]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_5:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_5]]
...
; CHECK-NEXT:    [[ARRAYIDX_6:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_6]]
; CHECK-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX_6]], align 4
; CHECK-NEXT:    [[MUL32_6:%.*]] = mul nsw i32 [[INC_5]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_6:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_6]]
...
; CHECK-NEXT:    [[ARRAYIDX_7:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_7]]
; CHECK-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX_7]], align 4
; CHECK-NEXT:    [[MUL32_7:%.*]] = mul nsw i32 [[INC_6]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_7:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_7]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL30_CLONE]]
; CHECK-NEXT:    [[TMP36:%.*]] = load float, ptr [[ARRAYIDX_CLONE]], align 4
; CHECK-NEXT:    [[MUL32_CLONE:%.*]] = mul nsw i32 [[X_067_CLONE]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX33_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL32_CLONE]]
...
; CHECK-NEXT:    [[ADD_PTR]] = getelementptr inbounds [4 x i8], ptr [[I_DATA_070]], i32 [[MUL20]]
; CHECK-NEXT:    [[ADD_PTR35]] = getelementptr inbounds [4 x i8], ptr [[F_DATA_069]], i32 [[MUL23]]
