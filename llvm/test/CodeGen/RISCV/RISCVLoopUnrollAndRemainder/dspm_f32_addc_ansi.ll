...
; CHECK-NEXT:    [[ADD_PTR]] = getelementptr inbounds float, ptr [[OUTPUT_ADDR_059]], i32 [[ADD22]]
; CHECK-NEXT:    [[ADD_PTR31]] = getelementptr inbounds float, ptr [[PTR_INPUT_060]], i32 [[ADD]]
