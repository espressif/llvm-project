...
; CHECK-NEXT:    [[ARRAYIDX_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[I_012_MODIFY]]
...
; CHECK-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD10]]
; CHECK-NEXT:    store i32 [[TMP13]], ptr [[ARRAYIDX12]], align 4
; CHECK-NEXT:    [[ADD13:%.*]] = or disjoint i32 [[I_012_MODIFY]], 5
; CHECK-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD13]]
...
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD13]]
; CHECK-NEXT:    store i32 [[TMP16]], ptr [[ARRAYIDX15]], align 4
; CHECK-NEXT:    [[ADD16:%.*]] = or disjoint i32 [[I_012_MODIFY]], 6
; CHECK-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD16]]
...
; CHECK-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD16]]
; CHECK-NEXT:    store i32 [[TMP19]], ptr [[ARRAYIDX18]], align 4
; CHECK-NEXT:    [[ADD19:%.*]] = or disjoint i32 [[I_012_MODIFY]], 7
; CHECK-NEXT:    [[ARRAYIDX20:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD19]]
...
; CHECK-NEXT:    [[ARRAYIDX21:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD19]]
; CHECK-NEXT:    store i32 [[TMP22]], ptr [[ARRAYIDX21]], align 4
; CHECK-NEXT:    [[ADD22:%.*]] = or disjoint i32 [[I_012_MODIFY]], 8
; CHECK-NEXT:    [[ARRAYIDX23:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD22]]
...
; CHECK-NEXT:    [[ARRAYIDX24:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD22]]
; CHECK-NEXT:    store i32 [[TMP25]], ptr [[ARRAYIDX24]], align 4
; CHECK-NEXT:    [[ADD25:%.*]] = or disjoint i32 [[I_012_MODIFY]], 9
; CHECK-NEXT:    [[ARRAYIDX26:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD25]]
...
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD25]]
; CHECK-NEXT:    store i32 [[TMP28]], ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    [[ADD28:%.*]] = or disjoint i32 [[I_012_MODIFY]], 10
; CHECK-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD28]]
...
; CHECK-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD28]]
; CHECK-NEXT:    store i32 [[TMP31]], ptr [[ARRAYIDX30]], align 4
; CHECK-NEXT:    [[ADD31:%.*]] = or disjoint i32 [[I_012_MODIFY]], 11
; CHECK-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD31]]
...
; CHECK-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD31]]
; CHECK-NEXT:    store i32 [[TMP34]], ptr [[ARRAYIDX33]], align 4
; CHECK-NEXT:    [[ADD34:%.*]] = or disjoint i32 [[I_012_MODIFY]], 12
; CHECK-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD34]]
...
; CHECK-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD34]]
; CHECK-NEXT:    store i32 [[TMP37]], ptr [[ARRAYIDX36]], align 4
; CHECK-NEXT:    [[ADD37:%.*]] = or disjoint i32 [[I_012_MODIFY]], 13
; CHECK-NEXT:    [[ARRAYIDX38:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD37]]
...
; CHECK-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD37]]
; CHECK-NEXT:    store i32 [[TMP40]], ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[ADD40:%.*]] = or disjoint i32 [[I_012_MODIFY]], 14
; CHECK-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD40]]
...
; CHECK-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD40]]
; CHECK-NEXT:    store i32 [[TMP43]], ptr [[ARRAYIDX42]], align 4
; CHECK-NEXT:    [[ADD43:%.*]] = or disjoint i32 [[I_012_MODIFY]], 15
; CHECK-NEXT:    [[ARRAYIDX44:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD43]]
...
; CHECK-NEXT:    [[ARRAYIDX45:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD43]]
...
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[I_012]]
...
; CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[I_012]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[INPUT]], i32 [[I_012_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX5_CLONE:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[OUTPUT]], i32 [[I_012_CLONE]]
