...
; CHECK-NEXT:    [[ADD_I_MODIFY:%.*]] = or disjoint i32 [[SHR_I_MODIFY]], 532365312
...
; CHECK-NEXT:    [[TMP4:%.*]] = or disjoint i32 [[TMP3]], 532365312
...
; CHECK-NEXT:    [[TMP7:%.*]] = or disjoint i32 [[TMP6]], 532365312
...
; CHECK-NEXT:    [[TMP10:%.*]] = or disjoint i32 [[TMP9]], 532365312
...
; CHECK-NEXT:    [[TMP13:%.*]] = or disjoint i32 [[TMP12]], 532365312
...
; CHECK-NEXT:    [[TMP16:%.*]] = or disjoint i32 [[TMP15]], 532365312
...
; CHECK-NEXT:    [[TMP19:%.*]] = or disjoint i32 [[TMP18]], 532365312
...
; CHECK-NEXT:    [[TMP22:%.*]] = or disjoint i32 [[TMP21]], 532365312
...
; CHECK-NEXT:    [[TMP25:%.*]] = or disjoint i32 [[TMP24]], 532365312
...
; CHECK-NEXT:    [[TMP28:%.*]] = or disjoint i32 [[TMP27]], 532365312
...
; CHECK-NEXT:    [[TMP31:%.*]] = or disjoint i32 [[TMP30]], 532365312
...
; CHECK-NEXT:    [[TMP34:%.*]] = or disjoint i32 [[TMP33]], 532365312
...
; CHECK-NEXT:    [[TMP37:%.*]] = or disjoint i32 [[TMP36]], 532365312
...
; CHECK-NEXT:    [[TMP40:%.*]] = or disjoint i32 [[TMP39]], 532365312
...
; CHECK-NEXT:    [[TMP43:%.*]] = or disjoint i32 [[TMP42]], 532365312
...
; CHECK-NEXT:    [[TMP46:%.*]] = or disjoint i32 [[TMP45]], 532365312
