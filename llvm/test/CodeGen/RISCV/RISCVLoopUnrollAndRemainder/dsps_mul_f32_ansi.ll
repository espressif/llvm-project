...
; CHECK-NEXT:    [[ARRAYIDX_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[I_022_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX9_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[I_022_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX12_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[I_022_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD]]
; CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD]]
; CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD4]]
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD4]]
; CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD4]]
; CHECK-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD8]]
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD8]]
; CHECK-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD8]]
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD14]]
; CHECK-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD14]]
; CHECK-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD14]]
...
; CHECK-NEXT:    [[ARRAYIDX21:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD18]]
; CHECK-NEXT:    [[ARRAYIDX23:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD22]]
; CHECK-NEXT:    [[ARRAYIDX24:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD22]]
; CHECK-NEXT:    [[ARRAYIDX25:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD22]]
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD26]]
; CHECK-NEXT:    [[ARRAYIDX28:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD26]]
; CHECK-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD26]]
; CHECK-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD34]]
; CHECK-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD34]]
; CHECK-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD34]]
...
; CHECK-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD42]]
; CHECK-NEXT:    [[ARRAYIDX44:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD42]]
; CHECK-NEXT:    [[ARRAYIDX45:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD42]]
; CHECK-NEXT:    [[ARRAYIDX47:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD46]]
; CHECK-NEXT:    [[ARRAYIDX48:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD46]]
; CHECK-NEXT:    [[ARRAYIDX49:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD46]]
; CHECK-NEXT:    [[ARRAYIDX51:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD50]]
; CHECK-NEXT:    [[ARRAYIDX52:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD50]]
; CHECK-NEXT:    [[ARRAYIDX53:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD50]]
; CHECK-NEXT:    [[ARRAYIDX55:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD54]]
; CHECK-NEXT:    [[ARRAYIDX56:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD54]]
; CHECK-NEXT:    [[ARRAYIDX57:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD54]]
...
; CHECK-NEXT:    [[ARRAYIDX61:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD58]]
...
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[MUL]]
; CHECK-NEXT:    [[TMP49:%.*]] = load float, ptr [[ARRAYIDX1]], align 4
; CHECK-NEXT:    [[MUL8:%.*]] = mul nsw i32 [[I_022]], [[STEP2]]
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[MUL8]]
...
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL11]]
...
; CHECK-NEXT:    [[ARRAYIDX12_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL11_CLONE]]
