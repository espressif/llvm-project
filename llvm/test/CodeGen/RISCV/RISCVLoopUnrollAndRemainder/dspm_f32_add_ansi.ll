...
; CHECK-NEXT:    [[ARRAYIDX_1_PHI_TRANS_INSERT:%.*]] = getelementptr inbounds float, ptr [[PTR_INPUT1_083]], i32 [[STEP1]]
; CHECK-NEXT:    [[DOTPRE2:%.*]] = load float, ptr [[ARRAYIDX_1_PHI_TRANS_INSERT]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_1_PHI_TRANS_INSERT:%.*]] = getelementptr inbounds float, ptr [[PTR_INPUT2_084]], i32 [[STEP2]]
...
; CHECK-NEXT:    [[ARRAYIDX42_1:%.*]] = getelementptr inbounds float, ptr [[OUTPUT_ADDR_082]], i32 [[STEP_OUT]]
; CHECK-NEXT:    store float [[ADD40_1]], ptr [[ARRAYIDX42_1]], align 4
; CHECK-NEXT:    [[ARRAYIDX_2_IDX:%.*]] = shl nsw i32 [[STEP1]], 3
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_2_IDX]]
; CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[ARRAYIDX_2]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_2_IDX:%.*]] = shl nsw i32 [[STEP2]], 3
; CHECK-NEXT:    [[ARRAYIDX39_2:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_2_IDX]]
; CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[ARRAYIDX39_2]], align 4
; CHECK-NEXT:    [[ADD40_2:%.*]] = fadd float [[TMP3]], [[TMP4]]
; CHECK-NEXT:    [[ARRAYIDX42_2_IDX:%.*]] = shl nsw i32 [[STEP_OUT]], 3
; CHECK-NEXT:    [[ARRAYIDX42_2:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_2_IDX]]
; CHECK-NEXT:    store float [[ADD40_2]], ptr [[ARRAYIDX42_2]], align 4
; CHECK-NEXT:    [[ARRAYIDX_3_IDX:%.*]] = mul i32 [[STEP1]], 12
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_3_IDX]]
; CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[ARRAYIDX_3]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_3_IDX:%.*]] = mul i32 [[STEP2]], 12
; CHECK-NEXT:    [[ARRAYIDX39_3:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_3_IDX]]
; CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[ARRAYIDX39_3]], align 4
; CHECK-NEXT:    [[ADD40_3:%.*]] = fadd float [[TMP5]], [[TMP6]]
; CHECK-NEXT:    [[ARRAYIDX42_3_IDX:%.*]] = mul i32 [[STEP_OUT]], 12
; CHECK-NEXT:    [[ARRAYIDX42_3:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_3_IDX]]
; CHECK-NEXT:    store float [[ADD40_3]], ptr [[ARRAYIDX42_3]], align 4
; CHECK-NEXT:    [[ARRAYIDX_4_IDX:%.*]] = shl nsw i32 [[STEP1]], 4
; CHECK-NEXT:    [[ARRAYIDX_4:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_4_IDX]]
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[ARRAYIDX_4]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_4_IDX:%.*]] = shl nsw i32 [[STEP2]], 4
; CHECK-NEXT:    [[ARRAYIDX39_4:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_4_IDX]]
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX39_4]], align 4
; CHECK-NEXT:    [[ADD40_4:%.*]] = fadd float [[TMP7]], [[TMP8]]
; CHECK-NEXT:    [[ARRAYIDX42_4_IDX:%.*]] = shl nsw i32 [[STEP_OUT]], 4
; CHECK-NEXT:    [[ARRAYIDX42_4:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_4_IDX]]
; CHECK-NEXT:    store float [[ADD40_4]], ptr [[ARRAYIDX42_4]], align 4
; CHECK-NEXT:    [[ARRAYIDX_5_IDX:%.*]] = mul i32 [[STEP1]], 20
; CHECK-NEXT:    [[ARRAYIDX_5:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_5_IDX]]
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX_5]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_5_IDX:%.*]] = mul i32 [[STEP2]], 20
; CHECK-NEXT:    [[ARRAYIDX39_5:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_5_IDX]]
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX39_5]], align 4
; CHECK-NEXT:    [[ADD40_5:%.*]] = fadd float [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[ARRAYIDX42_5_IDX:%.*]] = mul i32 [[STEP_OUT]], 20
; CHECK-NEXT:    [[ARRAYIDX42_5:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_5_IDX]]
; CHECK-NEXT:    store float [[ADD40_5]], ptr [[ARRAYIDX42_5]], align 4
; CHECK-NEXT:    [[ARRAYIDX_6_IDX:%.*]] = mul i32 [[STEP1]], 24
; CHECK-NEXT:    [[ARRAYIDX_6:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_6_IDX]]
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX_6]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_6_IDX:%.*]] = mul i32 [[STEP2]], 24
; CHECK-NEXT:    [[ARRAYIDX39_6:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_6_IDX]]
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX39_6]], align 4
; CHECK-NEXT:    [[ADD40_6:%.*]] = fadd float [[TMP11]], [[TMP12]]
; CHECK-NEXT:    [[ARRAYIDX42_6_IDX:%.*]] = mul i32 [[STEP_OUT]], 24
; CHECK-NEXT:    [[ARRAYIDX42_6:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_6_IDX]]
; CHECK-NEXT:    store float [[ADD40_6]], ptr [[ARRAYIDX42_6]], align 4
; CHECK-NEXT:    [[ARRAYIDX_7_IDX:%.*]] = mul i32 [[STEP1]], 28
; CHECK-NEXT:    [[ARRAYIDX_7:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT1_083]], i32 [[ARRAYIDX_7_IDX]]
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX_7]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_7_IDX:%.*]] = mul i32 [[STEP2]], 28
; CHECK-NEXT:    [[ARRAYIDX39_7:%.*]] = getelementptr inbounds i8, ptr [[PTR_INPUT2_084]], i32 [[ARRAYIDX39_7_IDX]]
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX39_7]], align 4
; CHECK-NEXT:    [[ADD40_8:%.*]] = fadd float [[TMP13]], [[TMP14]]
; CHECK-NEXT:    [[ARRAYIDX42_7_IDX:%.*]] = mul i32 [[STEP_OUT]], 28
; CHECK-NEXT:    [[ARRAYIDX42_7:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT_ADDR_082]], i32 [[ARRAYIDX42_7_IDX]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds float, ptr [[PTR_INPUT1_083]], i32 [[MUL_CLONE]]
; CHECK-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX_CLONE]], align 4
; CHECK-NEXT:    [[MUL38_CLONE:%.*]] = mul nuw nsw i32 [[COL_080_CLONE]], [[STEP2]]
; CHECK-NEXT:    [[ARRAYIDX39_CLONE:%.*]] = getelementptr inbounds float, ptr [[PTR_INPUT2_084]], i32 [[MUL38_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX42_CLONE:%.*]] = getelementptr inbounds float, ptr [[OUTPUT_ADDR_082]], i32 [[MUL41_CLONE]]
...
; CHECK-NEXT:    [[ADD_PTR]] = getelementptr inbounds float, ptr [[PTR_INPUT1_083]], i32 [[ADD]]
; CHECK-NEXT:    [[ADD_PTR43]] = getelementptr inbounds float, ptr [[PTR_INPUT2_084]], i32 [[ADD31]]
; CHECK-NEXT:    [[ADD_PTR44]] = getelementptr inbounds float, ptr [[OUTPUT_ADDR_082]], i32 [[ADD32]]
