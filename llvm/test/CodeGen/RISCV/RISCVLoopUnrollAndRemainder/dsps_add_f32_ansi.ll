...
; CHECK-NEXT:    [[ARRAYIDX_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[I_021_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX9_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[I_021_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX11_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[I_021_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD2]]
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD2]]
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD2]]
; CHECK-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD7]]
; CHECK-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD7]]
; CHECK-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD7]]
; CHECK-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX19:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD18]]
; CHECK-NEXT:    [[ARRAYIDX20:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD18]]
; CHECK-NEXT:    [[ARRAYIDX22:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD18]]
; CHECK-NEXT:    [[ARRAYIDX24:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD23]]
; CHECK-NEXT:    [[ARRAYIDX25:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD23]]
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD23]]
; CHECK-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD28]]
; CHECK-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD28]]
; CHECK-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD28]]
; CHECK-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD33]]
; CHECK-NEXT:    [[ARRAYIDX35:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD33]]
; CHECK-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD33]]
; CHECK-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX40:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX42:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX44:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD43]]
; CHECK-NEXT:    [[ARRAYIDX45:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD43]]
; CHECK-NEXT:    [[ARRAYIDX47:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD43]]
; CHECK-NEXT:    [[ARRAYIDX49:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD48]]
; CHECK-NEXT:    [[ARRAYIDX50:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD48]]
; CHECK-NEXT:    [[ARRAYIDX52:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD48]]
; CHECK-NEXT:    [[ARRAYIDX54:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD53]]
; CHECK-NEXT:    [[ARRAYIDX55:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD53]]
; CHECK-NEXT:    [[ARRAYIDX57:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD53]]
; CHECK-NEXT:    [[ARRAYIDX59:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD58]]
; CHECK-NEXT:    [[ARRAYIDX60:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD58]]
; CHECK-NEXT:    [[ARRAYIDX62:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD58]]
; CHECK-NEXT:    [[ARRAYIDX64:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD63]]
; CHECK-NEXT:    [[ARRAYIDX65:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD63]]
; CHECK-NEXT:    [[ARRAYIDX67:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD63]]
; CHECK-NEXT:    [[ARRAYIDX69:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD68]]
; CHECK-NEXT:    [[ARRAYIDX70:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD68]]
; CHECK-NEXT:    [[ARRAYIDX72:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD68]]
; CHECK-NEXT:    [[ARRAYIDX74:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[ADD73]]
; CHECK-NEXT:    [[ARRAYIDX75:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[ADD73]]
; CHECK-NEXT:    [[ARRAYIDX77:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD73]]
...
; CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[MUL]]
; CHECK-NEXT:    [[TMP34:%.*]] = load float, ptr [[ARRAYIDX3]], align 4
; CHECK-NEXT:    [[MUL8:%.*]] = mul nsw i32 [[I_021]], [[STEP2]]
; CHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[MUL8]]
...
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL10]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT1]], i32 [[MUL_CLONE]]
; CHECK-NEXT:    [[TMP36:%.*]] = load float, ptr [[ARRAYIDX_CLONE]], align 4
; CHECK-NEXT:    [[MUL8_CLONE:%.*]] = mul nsw i32 [[I_021_CLONE]], [[STEP2]]
; CHECK-NEXT:    [[ARRAYIDX9_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT2]], i32 [[MUL8_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX11_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL10_CLONE]]
