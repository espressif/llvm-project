...
; CHECK-NEXT:    [[ARRAYIDX_1_PHI_TRANS_INSERT:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[PTR_INPUT1_082]], i32 [[STEP1]]
; CHECK-NEXT:    [[DOTPRE3:%.*]] = load float, ptr [[ARRAYIDX_1_PHI_TRANS_INSERT]], align 4
; CHECK-NEXT:    [[ARRAYIDX39_1_PHI_TRANS_INSERT:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[PTR_INPUT2_083]], i32 [[STEP2]]
...
; CHECK-NEXT:    [[ARRAYIDX41_1:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[OUTPUT_ADDR_081]], i32 [[STEP_OUT]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[PTR_INPUT1_082]], i32 [[MUL_CLONE]]
; CHECK-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX_CLONE]], align 4
; CHECK-NEXT:    [[MUL38_CLONE:%.*]] = mul nuw nsw i32 [[COL_079_CLONE]], [[STEP2]]
; CHECK-NEXT:    [[ARRAYIDX39_CLONE:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[PTR_INPUT2_083]], i32 [[MUL38_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX41_CLONE:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[OUTPUT_ADDR_081]], i32 [[MUL40_CLONE]]
...
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr [4 x i8], ptr [[PTR_INPUT1_082]], i32 [[PADD1]]
; CHECK-NEXT:    [[ADD_PTR]] = getelementptr [4 x i8], ptr [[TMP21]], i32 [[COLS]]
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr [4 x i8], ptr [[PTR_INPUT2_083]], i32 [[PADD2]]
; CHECK-NEXT:    [[ADD_PTR42]] = getelementptr [4 x i8], ptr [[TMP22]], i32 [[COLS]]
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr [4 x i8], ptr [[OUTPUT_ADDR_081]], i32 [[PADD_OUT]]
; CHECK-NEXT:    [[ADD_PTR43]] = getelementptr [4 x i8], ptr [[TMP23]], i32 [[COLS]]
