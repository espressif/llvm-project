...
; CHECK-NEXT:    [[ARRAYIDX_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[I_013_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX6_MODIFY:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[I_013_MODIFY]]
; CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD2]]
; CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD2]]
; CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD6]]
; CHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD6]]
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD10]]
; CHECK-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD10]]
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD14]]
; CHECK-NEXT:    [[ARRAYIDX17:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD14]]
; CHECK-NEXT:    [[ARRAYIDX19:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD18]]
...
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD26]]
; CHECK-NEXT:    [[ARRAYIDX29:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD26]]
; CHECK-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD30]]
...
; CHECK-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD38]]
; CHECK-NEXT:    [[ARRAYIDX43:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD42]]
; CHECK-NEXT:    [[ARRAYIDX45:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD42]]
; CHECK-NEXT:    [[ARRAYIDX47:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD46]]
; CHECK-NEXT:    [[ARRAYIDX49:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD46]]
; CHECK-NEXT:    [[ARRAYIDX51:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD50]]
; CHECK-NEXT:    [[ARRAYIDX53:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD50]]
; CHECK-NEXT:    [[ARRAYIDX55:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD54]]
; CHECK-NEXT:    [[ARRAYIDX57:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[ADD54]]
; CHECK-NEXT:    [[ARRAYIDX59:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[ADD58]]
...
; CHECK-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[MUL]]
...
; CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL5]]
...
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[INPUT]], i32 [[MUL_CLONE]]
...
; CHECK-NEXT:    [[ARRAYIDX6_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[OUTPUT]], i32 [[MUL5_CLONE]]
