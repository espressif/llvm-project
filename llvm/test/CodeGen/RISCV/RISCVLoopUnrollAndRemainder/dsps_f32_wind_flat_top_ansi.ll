...
; CHECK-NEXT:    [[MUL1:%.*]] = fmul nnan double [[CONV4]], f0x401921FB54442D18
...
; CHECK-NEXT:    [[MUL54:%.*]] = fmul nnan float [[CONV22]], 4.000000e+00
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[I_043]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_1]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_1:%.*]] = fmul nnan float [[MUL33]], [[CONV5_1]]
; CHECK-NEXT:    [[CALL14_1:%.*]] = tail call float @cosf(float noundef [[MUL9_1]])
; CHECK-NEXT:    [[TMP5:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_1]], float f0x3E8DF570, float [[TMP4]])
; CHECK-NEXT:    [[MUL125_1:%.*]] = fmul nnan float [[MUL4]], [[CONV5_1]]
; CHECK-NEXT:    [[CALL22_1:%.*]] = tail call float @cosf(float noundef [[MUL125_1]])
; CHECK-NEXT:    [[TMP6:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_1]], float f0xBDAB2B70, float [[TMP5]])
; CHECK-NEXT:    [[MUL15_1:%.*]] = fmul nnan float [[MUL54]], [[CONV5_1]]
; CHECK-NEXT:    [[CALL30_1:%.*]] = tail call float @cosf(float noundef [[MUL15_1]])
; CHECK-NEXT:    [[TMP7:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_1]], float f0x3BE3A6BF, float [[TMP6]])
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_2]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_2:%.*]] = fmul nnan float [[MUL33]], [[CONV5_2]]
; CHECK-NEXT:    [[CALL14_2:%.*]] = tail call float @cosf(float noundef [[MUL9_2]])
; CHECK-NEXT:    [[TMP9:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_2]], float f0x3E8DF570, float [[TMP8]])
; CHECK-NEXT:    [[MUL125_2:%.*]] = fmul nnan float [[MUL4]], [[CONV5_2]]
; CHECK-NEXT:    [[CALL22_2:%.*]] = tail call float @cosf(float noundef [[MUL125_2]])
; CHECK-NEXT:    [[TMP10:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_2]], float f0xBDAB2B70, float [[TMP9]])
; CHECK-NEXT:    [[MUL15_2:%.*]] = fmul nnan float [[MUL54]], [[CONV5_2]]
; CHECK-NEXT:    [[CALL30_2:%.*]] = tail call float @cosf(float noundef [[MUL15_2]])
; CHECK-NEXT:    [[TMP11:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_2]], float f0x3BE3A6BF, float [[TMP10]])
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_1]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_3]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_3:%.*]] = fmul nnan float [[MUL33]], [[CONV5_3]]
; CHECK-NEXT:    [[CALL14_3:%.*]] = tail call float @cosf(float noundef [[MUL9_3]])
; CHECK-NEXT:    [[TMP13:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_3]], float f0x3E8DF570, float [[TMP12]])
; CHECK-NEXT:    [[MUL125_3:%.*]] = fmul nnan float [[MUL4]], [[CONV5_3]]
; CHECK-NEXT:    [[CALL22_3:%.*]] = tail call float @cosf(float noundef [[MUL125_3]])
; CHECK-NEXT:    [[TMP14:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_3]], float f0xBDAB2B70, float [[TMP13]])
; CHECK-NEXT:    [[MUL15_3:%.*]] = fmul nnan float [[MUL54]], [[CONV5_3]]
; CHECK-NEXT:    [[CALL30_3:%.*]] = tail call float @cosf(float noundef [[MUL15_3]])
; CHECK-NEXT:    [[TMP15:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_3]], float f0x3BE3A6BF, float [[TMP14]])
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_2]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_4]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_4:%.*]] = fmul nnan float [[MUL33]], [[CONV5_4]]
; CHECK-NEXT:    [[CALL14_4:%.*]] = tail call float @cosf(float noundef [[MUL9_4]])
; CHECK-NEXT:    [[TMP17:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_4]], float f0x3E8DF570, float [[TMP16]])
; CHECK-NEXT:    [[MUL125_4:%.*]] = fmul nnan float [[MUL4]], [[CONV5_4]]
; CHECK-NEXT:    [[CALL22_4:%.*]] = tail call float @cosf(float noundef [[MUL125_4]])
; CHECK-NEXT:    [[TMP18:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_4]], float f0xBDAB2B70, float [[TMP17]])
; CHECK-NEXT:    [[MUL15_4:%.*]] = fmul nnan float [[MUL54]], [[CONV5_4]]
; CHECK-NEXT:    [[CALL30_4:%.*]] = tail call float @cosf(float noundef [[MUL15_4]])
; CHECK-NEXT:    [[TMP19:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_4]], float f0x3BE3A6BF, float [[TMP18]])
; CHECK-NEXT:    [[ARRAYIDX_4:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_3]]
...
; CHECK-NEXT:    [[TMP20:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_5]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_5:%.*]] = fmul nnan float [[MUL33]], [[CONV5_5]]
; CHECK-NEXT:    [[CALL14_5:%.*]] = tail call float @cosf(float noundef [[MUL9_5]])
; CHECK-NEXT:    [[TMP21:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_5]], float f0x3E8DF570, float [[TMP20]])
; CHECK-NEXT:    [[MUL125_5:%.*]] = fmul nnan float [[MUL4]], [[CONV5_5]]
; CHECK-NEXT:    [[CALL22_5:%.*]] = tail call float @cosf(float noundef [[MUL125_5]])
; CHECK-NEXT:    [[TMP22:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_5]], float f0xBDAB2B70, float [[TMP21]])
; CHECK-NEXT:    [[MUL15_5:%.*]] = fmul nnan float [[MUL54]], [[CONV5_5]]
; CHECK-NEXT:    [[CALL30_5:%.*]] = tail call float @cosf(float noundef [[MUL15_5]])
; CHECK-NEXT:    [[TMP23:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_5]], float f0x3BE3A6BF, float [[TMP22]])
; CHECK-NEXT:    [[ARRAYIDX_5:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_4]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_6]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_6:%.*]] = fmul nnan float [[MUL33]], [[CONV5_6]]
; CHECK-NEXT:    [[CALL14_6:%.*]] = tail call float @cosf(float noundef [[MUL9_6]])
; CHECK-NEXT:    [[TMP25:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_6]], float f0x3E8DF570, float [[TMP24]])
; CHECK-NEXT:    [[MUL125_6:%.*]] = fmul nnan float [[MUL4]], [[CONV5_6]]
; CHECK-NEXT:    [[CALL22_6:%.*]] = tail call float @cosf(float noundef [[MUL125_6]])
; CHECK-NEXT:    [[TMP26:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_6]], float f0xBDAB2B70, float [[TMP25]])
; CHECK-NEXT:    [[MUL15_6:%.*]] = fmul nnan float [[MUL54]], [[CONV5_6]]
; CHECK-NEXT:    [[CALL30_6:%.*]] = tail call float @cosf(float noundef [[MUL15_6]])
; CHECK-NEXT:    [[TMP27:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_6]], float f0x3BE3A6BF, float [[TMP26]])
; CHECK-NEXT:    [[ARRAYIDX_6:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_5]]
...
; CHECK-NEXT:    [[TMP28:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_7]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_7:%.*]] = fmul nnan float [[MUL33]], [[CONV5_7]]
; CHECK-NEXT:    [[CALL14_7:%.*]] = tail call float @cosf(float noundef [[MUL9_7]])
; CHECK-NEXT:    [[TMP29:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_7]], float f0x3E8DF570, float [[TMP28]])
; CHECK-NEXT:    [[MUL125_7:%.*]] = fmul nnan float [[MUL4]], [[CONV5_7]]
; CHECK-NEXT:    [[CALL22_7:%.*]] = tail call float @cosf(float noundef [[MUL125_7]])
; CHECK-NEXT:    [[TMP30:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_7]], float f0xBDAB2B70, float [[TMP29]])
; CHECK-NEXT:    [[MUL15_7:%.*]] = fmul nnan float [[MUL54]], [[CONV5_7]]
; CHECK-NEXT:    [[CALL30_7:%.*]] = tail call float @cosf(float noundef [[MUL15_7]])
; CHECK-NEXT:    [[TMP31:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_7]], float f0x3BE3A6BF, float [[TMP30]])
; CHECK-NEXT:    [[ARRAYIDX_7:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[WINDOW]], i32 [[INC_6]]
...
; CHECK-NEXT:    [[TMP32:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_CLONE]], float f0xBED550BC, float f0x3E5CC0BA)
; CHECK-NEXT:    [[MUL9_CLONE:%.*]] = fmul float [[MUL33]], [[CONV5_CLONE]]
; CHECK-NEXT:    [[CALL14_CLONE:%.*]] = tail call float @cosf(float noundef [[MUL9_CLONE]])
; CHECK-NEXT:    [[TMP33:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_CLONE]], float f0x3E8DF570, float [[TMP32]])
...
; CHECK-NEXT:    [[TMP34:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_CLONE]], float f0xBDAB2B70, float [[TMP33]])
...
; CHECK-NEXT:    [[TMP35:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL30_CLONE]], float f0x3BE3A6BF, float [[TMP34]])
; CHECK-NEXT:    [[ARRAYIDX_CLONE:%.*]] = getelementptr inbounds [4 x i8], ptr [[WINDOW]], i32 [[I_043_CLONE]]
