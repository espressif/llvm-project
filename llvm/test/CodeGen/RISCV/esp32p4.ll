...
; CHECK-NEXT:    li s0, 8
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vld.128.ip q0, t3, 784
; CHECK-NEXT:    esp.vld.128.ip q1, a2, 784
; CHECK-NEXT:    esp.vld.128.ip q2, a3, 784
; CHECK-NEXT:    esp.vld.128.ip q3, a4, 784
; CHECK-NEXT:    esp.vld.128.ip q4, a5, 784
; CHECK-NEXT:    esp.vld.128.ip q5, s1, 784
; CHECK-NEXT:    esp.vld.128.ip q6, s0, 784
; CHECK-NEXT:    esp.vld.128.ip q7, a1, 784
; CHECK-NEXT:    esp.vcmulas.s16.qacc.h q0, q4
; CHECK-NEXT:    li a1, 10
; CHECK-NEXT:    li s9, 12
; CHECK-NEXT:    li a2, 2
; CHECK-NEXT:    li a3, 8
; CHECK-NEXT:    esp.vcmulas.s16.qacc.h.ld.ip q1, a1, -48, q6, q1
; CHECK-NEXT:    esp.vcmulas.s16.qacc.h.ld.xp q1, a2, s9, q2, q7
; CHECK-NEXT:    esp.vcmulas.s16.qacc.l q7, q6
; CHECK-NEXT:    esp.vcmulas.s16.qacc.l.ld.ip q7, a3, 48, q7, q0
; CHECK-NEXT:    li t3, 7
; CHECK-NEXT:    li a2, 14
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.vcmulas.s16.qacc.l.ld.xp q1, a1, a2, q2, q7
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    li a2, 2
; CHECK-NEXT:    li a3, 4
; CHECK-NEXT:    esp.vcmulas.s8.qacc.h q1, q1
; CHECK-NEXT:    esp.vcmulas.s8.qacc.h.ld.ip q4, a1, 32, q1, q6
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.vcmulas.s8.qacc.h.ld.xp q6, a2, t3, q3, q2
; CHECK-NEXT:    li a2, 4
; CHECK-NEXT:    esp.vcmulas.s8.qacc.l q4, q5
; CHECK-NEXT:    esp.vcmulas.s8.qacc.l.ld.ip q4, a3, -48, q2, q5
; CHECK-NEXT:    esp.vcmulas.s8.qacc.l.ld.xp q7, a1, t3, q6, q3
; CHECK-NEXT:    li a3, 3
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vmulas.s16.qacc q4, q2
; CHECK-NEXT:    esp.vmulas.s16.qacc.ld.ip q1, a2, 96, q5, q7
; CHECK-NEXT:    esp.vmulas.s16.qacc.ld.xp q6, a1, a3, q4, q2
; CHECK-NEXT:    li a1, 0
; CHECK-NEXT:    esp.vmulas.s16.qacc.st.ip q1, a1, 80, q7, q6
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.vmulas.s16.qacc.st.xp q6, a1, a1, q0, q7
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    esp.vmulas.s16.xacc q3, q5
; CHECK-NEXT:    esp.vmulas.s16.xacc.ld.ip q5, a1, 96, q1, q7
; CHECK-NEXT:    li a3, 8
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    li a2, 1
; CHECK-NEXT:    esp.vmulas.s16.xacc.ld.xp q0, a1, a3, q5, q5
; CHECK-NEXT:    esp.vmulas.s16.xacc.st.ip q2, a2, 16, q4, q6
; CHECK-NEXT:    li t6, 5
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    li a2, 8
; CHECK-NEXT:    li a5, 8
; CHECK-NEXT:    esp.vmulas.s16.xacc.st.xp q7, a1, t6, q7, q7
; CHECK-NEXT:    esp.vmulas.s8.qacc q6, q1
; CHECK-NEXT:    esp.vmulas.s8.qacc.ld.ip q2, a2, -128, q3, q5
; CHECK-NEXT:    esp.vmulas.s8.qacc.ld.xp q4, a5, t6, q0, q5
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    esp.vmulas.s8.qacc.st.ip q7, a1, 16, q6, q0
; CHECK-NEXT:    li a1, 10
; CHECK-NEXT:    esp.vmulas.s8.qacc.st.xp q4, a1, s9, q6, q1
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    esp.vmulas.s8.xacc q3, q7
; CHECK-NEXT:    esp.vmulas.s8.xacc.ld.ip q7, a1, -16, q4, q5
; CHECK-NEXT:    li a2, 10
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.vmulas.s8.xacc.ld.xp q1, a1, a2, q7, q0
; CHECK-NEXT:    li a5, 2
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    li a2, 4
; CHECK-NEXT:    esp.vmulas.s8.xacc.st.ip q6, a1, -128, q6, q1
; CHECK-NEXT:    esp.vmulas.s8.xacc.st.xp q5, a2, a5, q4, q1
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vmulas.u16.qacc q6, q1
; CHECK-NEXT:    esp.vmulas.u16.qacc.ld.ip q7, a1, -32, q0, q0
; CHECK-NEXT:    li a1, 6
; CHECK-NEXT:    esp.vmulas.u16.qacc.ld.xp q2, a1, t3, q6, q7
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vmulas.u16.qacc.st.ip q4, a1, 16, q6, q5
; CHECK-NEXT:    li s0, 9
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    esp.vmulas.u16.qacc.st.xp q4, a1, s0, q3, q7
; CHECK-NEXT:    esp.vmulas.u16.xacc q6, q1
; CHECK-NEXT:    li a2, 6
; CHECK-NEXT:    li a1, 3
; CHECK-NEXT:    li s1, 0
; CHECK-NEXT:    esp.vmulas.u16.xacc.ld.ip q2, a1, -48, q2, q2
; CHECK-NEXT:    esp.vmulas.u16.xacc.ld.xp q7, s1, a2, q3, q0
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    esp.vmulas.u16.xacc.st.ip q0, a1, 96, q1, q4
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    esp.vmulas.u16.xacc.st.xp q6, a1, t6, q3, q7
; CHECK-NEXT:    esp.vmulas.u8.qacc q7, q1
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    esp.vmulas.u8.qacc.ld.ip q7, a1, -48, q7, q4
; CHECK-NEXT:    li a1, 11
; CHECK-NEXT:    esp.vmulas.u8.qacc.ld.xp q4, a1, s9, q6, q7
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.vmulas.u8.qacc.st.ip q2, a1, 0, q1, q7
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.vmulas.u8.qacc.st.xp q4, a1, a1, q0, q0
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.vmulas.u8.xacc q6, q4
; CHECK-NEXT:    esp.vmulas.u8.xacc.ld.ip q3, a1, -80, q6, q2
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    li s1, 5
; CHECK-NEXT:    esp.vmulas.u8.xacc.ld.xp q4, a1, a1, q5, q1
; CHECK-NEXT:    esp.vmulas.u8.xacc.st.ip q7, s1, -128, q2, q3
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.vmulas.u8.xacc.st.xp q2, a1, a2, q7, q2
; CHECK-NEXT:    li s8, 14
; CHECK-NEXT:    li s1, 0
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vmulas.s16.qacc.ldbc.incp q0, s8, q0, q2
; CHECK-NEXT:    esp.vmulas.s8.qacc.ldbc.incp q5, s1, q2, q6
; CHECK-NEXT:    esp.vmulas.u16.qacc.ldbc.incp q5, a1, q7, q3
; CHECK-NEXT:    li a1, 6
; CHECK-NEXT:    esp.vmulas.u8.qacc.ldbc.incp q3, a1, q4, q4
; CHECK-NEXT:    esp.vsmulas.s16.qacc q1, q5, 14
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.vsmulas.s16.qacc.ld.incp q0, a1, q7, q4, 0
; CHECK-NEXT:    esp.vsmulas.s8.qacc q3, q5, 0
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    esp.vsmulas.s8.qacc.ld.incp q1, a1, q1, q4, 6
; CHECK-NEXT:    li a1, 0
; CHECK-NEXT:    esp.vsmulas.u16.qacc q6, q5, 15
; CHECK-NEXT:    esp.vsmulas.u16.qacc.ld.incp q7, a1, q7, q1, 10
; CHECK-NEXT:    li a1, 10
; CHECK-NEXT:    li s1, 6
; CHECK-NEXT:    esp.vsmulas.u8.qacc q0, q7, 2
; CHECK-NEXT:    esp.vsmulas.u8.qacc.ld.incp q4, a1, q3, q7, 8
; CHECK-NEXT:    esp.cmul.s16 q6, q0, q7, 3
; CHECK-NEXT:    esp.cmul.s16.ld.incp q5, s1, q3, q0, q3, 0
; CHECK-NEXT:    li s8, 0
; CHECK-NEXT:    li s1, 5
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.cmul.s16.st.incp q5, s8, q0, q4, q5, 2
; CHECK-NEXT:    esp.cmul.s8 q1, q1, q0, 3
; CHECK-NEXT:    esp.cmul.s8.ld.incp q4, s1, q7, q5, q4, 1
; CHECK-NEXT:    esp.cmul.s8.st.incp q5, a1, q0, q6, q0, 3
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    li s1, 5
; CHECK-NEXT:    esp.cmul.u16 q7, q7, q5, 2
; CHECK-NEXT:    esp.cmul.u16.ld.incp q0, a1, q0, q0, q1, 1
; CHECK-NEXT:    esp.cmul.u16.st.incp q2, s1, q4, q1, q4, 2
; CHECK-NEXT:    li a1, 11
; CHECK-NEXT:    li s1, 10
; CHECK-NEXT:    esp.cmul.u8 q3, q7, q5, 0
; CHECK-NEXT:    esp.cmul.u8.ld.incp q4, a1, q0, q0, q2, 0
; CHECK-NEXT:    esp.cmul.u8.st.incp q1, s1, q4, q6, q3, 2
; CHECK-NEXT:    li a1, 10
; CHECK-NEXT:    esp.max.s16.a q6, s1
; CHECK-NEXT:    esp.max.s32.a q2, s1
; CHECK-NEXT:    esp.max.s8.a q0, s1
; CHECK-NEXT:    esp.max.u16.a q6, s1
; CHECK-NEXT:    esp.max.u32.a q6, s1
; CHECK-NEXT:    esp.max.u8.a q1, s1
; CHECK-NEXT:    esp.min.s16.a q6, s1
; CHECK-NEXT:    esp.min.s32.a q1, s1
; CHECK-NEXT:    esp.min.s8.a q0, s1
; CHECK-NEXT:    esp.min.u16.a q3, s1
; CHECK-NEXT:    esp.min.u32.a q0, s1
; CHECK-NEXT:    esp.min.u8.a q5, s1
; CHECK-NEXT:    esp.vabs.16 q6, q0
; CHECK-NEXT:    esp.vabs.32 q1, q4
; CHECK-NEXT:    esp.vabs.8 q5, q2
; CHECK-NEXT:    esp.vadd.s16 q6, q1, q5
; CHECK-NEXT:    esp.vadd.s16.ld.incp q0, a1, q1, q0, q6
; CHECK-NEXT:    li a1, 11
; CHECK-NEXT:    esp.vadd.s16.st.incp q1, a1, q7, q0, q4
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.vadd.s32 q7, q7, q3
; CHECK-NEXT:    esp.vadd.s32.ld.incp q4, a1, q4, q7, q2
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    li s1, 14
; CHECK-NEXT:    esp.vadd.s32.st.incp q2, a1, q7, q1, q7
; CHECK-NEXT:    esp.vadd.s8 q7, q1, q7
; CHECK-NEXT:    esp.vadd.s8.ld.incp q2, s1, q1, q5, q6
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    li s1, 8
; CHECK-NEXT:    esp.vadd.s8.st.incp q3, a1, q4, q1, q0
; CHECK-NEXT:    esp.vadd.u16 q0, q7, q7
; CHECK-NEXT:    esp.vadd.u16.ld.incp q6, s1, q1, q7, q5
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    li s1, 2
; CHECK-NEXT:    li s8, 1
; CHECK-NEXT:    esp.vadd.u16.st.incp q0, a1, q7, q6, q3
; CHECK-NEXT:    esp.vadd.u32 q4, q0, q1
; CHECK-NEXT:    esp.vadd.u32.ld.incp q1, s1, q4, q5, q0
; CHECK-NEXT:    li s10, 8
; CHECK-NEXT:    li s1, 5
; CHECK-NEXT:    li a1, 11
; CHECK-NEXT:    esp.vadd.u32.st.incp q4, s8, q6, q0, q1
; CHECK-NEXT:    esp.vadd.u8 q5, q2, q5
; CHECK-NEXT:    esp.vadd.u8.ld.incp q7, s10, q1, q4, q3
; CHECK-NEXT:    esp.vadd.u8.st.incp q0, s1, q2, q0, q0
; CHECK-NEXT:    esp.vclamp.s16 q4, q5, 14
; CHECK-NEXT:    esp.vmax.s16 q5, q6, q5
; CHECK-NEXT:    esp.vmax.s16.ld.incp q2, a1, q3, q5, q5
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    li s1, 7
; CHECK-NEXT:    esp.vmax.s16.st.incp q3, a1, q4, q3, q5
; CHECK-NEXT:    esp.vmax.s32 q2, q5, q2
; CHECK-NEXT:    esp.vmax.s32.ld.incp q0, s1, q6, q0, q1
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    li s1, 2
; CHECK-NEXT:    esp.vmax.s32.st.incp q6, a1, q1, q7, q6
; CHECK-NEXT:    esp.vmax.s8 q7, q5, q7
; CHECK-NEXT:    esp.vmax.s8.ld.incp q6, s1, q1, q5, q1
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    esp.vmax.s8.st.incp q5, a1, q7, q1, q3
; CHECK-NEXT:    li a1, 0
; CHECK-NEXT:    li s8, 11
; CHECK-NEXT:    li s11, 4
; CHECK-NEXT:    esp.vmax.u16 q1, q4, q1
; CHECK-NEXT:    esp.vmax.u16.ld.incp q3, a1, q5, q5, q4
; CHECK-NEXT:    li s10, 6
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    li s1, 10
; CHECK-NEXT:    esp.vmax.u16.st.incp q5, s8, q5, q0, q7
; CHECK-NEXT:    esp.vmax.u32 q4, q0, q2
; CHECK-NEXT:    esp.vmax.u32.ld.incp q6, s11, q1, q0, q6
; CHECK-NEXT:    li s8, 3
; CHECK-NEXT:    esp.vmax.u32.st.incp q0, s10, q1, q4, q7
; CHECK-NEXT:    esp.vmax.u8 q5, q2, q0
; CHECK-NEXT:    esp.vmax.u8.ld.incp q0, a1, q5, q6, q1
; CHECK-NEXT:    esp.vmax.u8.st.incp q7, s1, q1, q6, q7
; CHECK-NEXT:    esp.vmin.s16 q4, q1, q3
; CHECK-NEXT:    esp.vmin.s16.ld.incp q2, s8, q2, q2, q1
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    li s1, 14
; CHECK-NEXT:    esp.vmin.s16.st.incp q2, a1, q1, q7, q6
; CHECK-NEXT:    esp.vmin.s32 q2, q0, q3
; CHECK-NEXT:    esp.vmin.s32.ld.incp q1, s1, q5, q7, q6
; CHECK-NEXT:    li a1, 6
; CHECK-NEXT:    li s1, 11
; CHECK-NEXT:    li s8, 6
; CHECK-NEXT:    esp.vmin.s32.st.incp q7, a1, q5, q5, q1
; CHECK-NEXT:    esp.vmin.s8 q2, q3, q6
; CHECK-NEXT:    esp.vmin.s8.ld.incp q7, s1, q1, q4, q3
; CHECK-NEXT:    li s10, 11
; CHECK-NEXT:    li s1, 12
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.vmin.s8.st.incp q1, s8, q4, q0, q1
; CHECK-NEXT:    esp.vmin.u16 q4, q3, q7
; CHECK-NEXT:    esp.vmin.u16.ld.incp q4, s10, q5, q6, q6
; CHECK-NEXT:    esp.vmin.u16.st.incp q1, s1, q2, q6, q0
; CHECK-NEXT:    esp.vmin.u32 q5, q0, q7
; CHECK-NEXT:    esp.vmin.u32.ld.incp q7, a1, q6, q5, q6
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    li s1, 0
; CHECK-NEXT:    esp.vmin.u32.st.incp q5, a1, q4, q3, q7
; CHECK-NEXT:    esp.vmin.u8 q7, q5, q5
; CHECK-NEXT:    esp.vmin.u8.ld.incp q2, s1, q5, q0, q5
; CHECK-NEXT:    li a1, 12
; CHECK-NEXT:    li s1, 10
; CHECK-NEXT:    esp.vmin.u8.st.incp q2, a1, q1, q6, q6
; CHECK-NEXT:    esp.vmul.s16 q6, q2, q1
; CHECK-NEXT:    esp.vmul.s16.ld.incp q0, s1, q3, q6, q7
; CHECK-NEXT:    li s1, 4
; CHECK-NEXT:    li t5, 13
; CHECK-NEXT:    li s10, 3
; CHECK-NEXT:    li a1, 0
; CHECK-NEXT:    esp.vmul.s16.s8xs8 q7, q0, q3, q5
; CHECK-NEXT:    esp.vmul.s16.st.incp q2, s10, q0, q7, q1
; CHECK-NEXT:    esp.vmul.s32.s16xs16 q3, q4, q5, q2
; CHECK-NEXT:    esp.vmul.s8 q3, q4, q0
; CHECK-NEXT:    esp.vmul.s8.ld.incp q0, a1, q2, q2, q3
; CHECK-NEXT:    li a1, 8
; CHECK-NEXT:    li s10, 7
; CHECK-NEXT:    li s11, 3
; CHECK-NEXT:    esp.vmul.s8.st.incp q0, a1, q3, q0, q7
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    esp.vmul.u16 q2, q3, q7
; CHECK-NEXT:    esp.vmul.u16.ld.incp q5, s10, q5, q6, q6
; CHECK-NEXT:    esp.vmul.u16.st.incp q3, s11, q2, q4, q4
; CHECK-NEXT:    esp.vmul.u8 q7, q3, q7
; CHECK-NEXT:    esp.vmul.u8.ld.incp q0, a1, q1, q0, q6
; CHECK-NEXT:    li s10, 1
; CHECK-NEXT:    li s11, 11
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.vmul.u8.st.incp q7, a4, q4, q0, q3
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.vprelu.s16 q1, q4, q3, a3
; CHECK-NEXT:    li a1, 3
; CHECK-NEXT:    esp.vprelu.s8 q2, q4, q5, a1
; CHECK-NEXT:    esp.vrelu.s16 q6, s0, a3
; CHECK-NEXT:    esp.vrelu.s8 q5, s10, s9
; CHECK-NEXT:    esp.vsadds.s16 q3, q3, s9
; CHECK-NEXT:    esp.vsadds.s8 q7, q1, t3
; CHECK-NEXT:    esp.vsadds.u16 q3, q2, s1
; CHECK-NEXT:    esp.vsadds.u8 q2, q3, a3
; CHECK-NEXT:    esp.vsat.s16 q5, q0, s0, s10
; CHECK-NEXT:    esp.vsat.s32 q3, q3, s9, s0
; CHECK-NEXT:    li t4, 10
; CHECK-NEXT:    esp.vsat.s8 q0, q7, t4, a5
; CHECK-NEXT:    esp.vsat.u16 q3, q7, t3, t3
; CHECK-NEXT:    esp.vsat.u32 q3, q5, a3, a5
; CHECK-NEXT:    esp.vsat.u8 q0, q6, s10, t5
; CHECK-NEXT:    esp.vssubs.s16 q3, q7, a1
; CHECK-NEXT:    li t5, 3
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.vssubs.s8 q7, q0, a1
; CHECK-NEXT:    esp.vssubs.u16 q5, q4, a0
; CHECK-NEXT:    esp.vssubs.u8 q5, q1, s11
; CHECK-NEXT:    esp.vsub.s16 q0, q0, q6
; CHECK-NEXT:    esp.vsub.s16.ld.incp q2, a4, q2, q3, q7
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    esp.vsub.s16.st.incp q7, a4, q0, q0, q3
; CHECK-NEXT:    li a4, 7
; CHECK-NEXT:    esp.vsub.s32 q7, q2, q7
; CHECK-NEXT:    esp.vsub.s32.ld.incp q4, a4, q3, q2, q0
; CHECK-NEXT:    li a4, 5
; CHECK-NEXT:    esp.vsub.s32.st.incp q4, a4, q1, q1, q1
; CHECK-NEXT:    li a4, 1
; CHECK-NEXT:    esp.vsub.s8 q7, q5, q6
; CHECK-NEXT:    esp.vsub.s8.ld.incp q4, a4, q1, q2, q6
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.vsub.s8.st.incp q5, a4, q4, q2, q3
; CHECK-NEXT:    li a4, 11
; CHECK-NEXT:    esp.vsub.u16 q5, q7, q0
; CHECK-NEXT:    esp.vsub.u16.ld.incp q4, a4, q0, q7, q5
; CHECK-NEXT:    li a4, 11
; CHECK-NEXT:    esp.vsub.u16.st.incp q0, a4, q1, q3, q1
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    esp.vsub.u32 q5, q4, q2
; CHECK-NEXT:    esp.vsub.u32.ld.incp q4, a4, q2, q4, q2
; CHECK-NEXT:    li a4, 11
; CHECK-NEXT:    esp.vsub.u32.st.incp q0, a4, q7, q7, q4
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    esp.vsub.u8 q6, q5, q4
; CHECK-NEXT:    esp.vsub.u8.ld.incp q4, a4, q6, q2, q4
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.vsub.u8.st.incp q3, s11, q3, q2, q0
; CHECK-NEXT:    esp.addx2 zero, t6, a1
; CHECK-NEXT:    esp.addx4 zero, a1, t6
; CHECK-NEXT:    li s8, 14
; CHECK-NEXT:    esp.sat a4, a2, a5
; CHECK-NEXT:    esp.subx2 zero, a5, a5
; CHECK-NEXT:    esp.subx4 zero, zero, s0
...
; CHECK-NEXT:    esp.movi.16.a q2, a4, 3
; CHECK-NEXT:    esp.movi.16.q q3, t3, 13
; CHECK-NEXT:    esp.movi.32.a q6, a4, 1
; CHECK-NEXT:    esp.movi.32.q q5, s0, 1
; CHECK-NEXT:    esp.movi.8.a q5, a4, 15
; CHECK-NEXT:    esp.movi.8.q q1, a0, 6
; CHECK-NEXT:    esp.movx.r.cfg a4
; CHECK-NEXT:    esp.movx.r.fft.bit.width a4
; CHECK-NEXT:    esp.movx.r.perf a4, s11
; CHECK-NEXT:    esp.movx.r.sar a4
; CHECK-NEXT:    esp.movx.r.sar.bytes a4
; CHECK-NEXT:    esp.movx.r.xacc.h a4
; CHECK-NEXT:    esp.movx.r.xacc.l a4
; CHECK-NEXT:    esp.movx.w.cfg t4
; CHECK-NEXT:    li t4, 10
; CHECK-NEXT:    esp.movx.w.fft.bit.width s10
; CHECK-NEXT:    esp.movx.w.perf a3
; CHECK-NEXT:    esp.movx.w.sar t5
; CHECK-NEXT:    esp.movx.w.sar.bytes s1
; CHECK-NEXT:    esp.movx.w.xacc.h a3
...
; CHECK-NEXT:    esp.fft.ams.s16.ld.incp q6, a1, q6, q0, q3, q0, q1, 0
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.fft.ams.s16.ld.incp.uaup q3, a1, q0, q2, q3, q1, q0, 0
; CHECK-NEXT:    li a1, 3
; CHECK-NEXT:    esp.fft.ams.s16.ld.r32.decp q7, a1, q0, q6, q3, q1, q5, 1
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.fft.ams.s16.st.incp q5, q7, a1, a4, q5, q3, q6, 0
; CHECK-NEXT:    li a1, 2
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.fft.bitrev q7, a1
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    esp.fft.cmul.s16.ld.xp q2, a4, s10, q3, q7, q7, 1
; CHECK-NEXT:    li a4, 10
; CHECK-NEXT:    esp.fft.cmul.s16.st.xp q7, q0, q4, a1, a5, 4, 3, 1
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.fft.r2bf.s16 q7, q3, q5, q1, 0
; CHECK-NEXT:    esp.fft.r2bf.s16.st.incp q7, q7, q4, a4, 2
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.fft.vst.r32.decp q5, a1, 1
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    esp.ld.128.usar.ip q1, a4, 608
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.ld.128.usar.xp q2, a1, a3
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.ld.xacc.ip a4, 400
; CHECK-NEXT:    li a4, 2
; CHECK-NEXT:    esp.ldqa.s16.128.ip a1, 912
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    esp.ldqa.s16.128.xp a4, t4
; CHECK-NEXT:    li a4, 9
; CHECK-NEXT:    esp.ldqa.s8.128.ip a1, 1824
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    esp.ldqa.s8.128.xp a4, s1
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.ldqa.u16.128.ip a1, -1904
; CHECK-NEXT:    li a1, 3
; CHECK-NEXT:    esp.ldqa.u16.128.xp a4, s8
; CHECK-NEXT:    li a4, 2
; CHECK-NEXT:    esp.ldqa.u8.128.ip a1, 1216
; CHECK-NEXT:    li a1, 9
; CHECK-NEXT:    esp.ldqa.u8.128.xp a4, a2
; CHECK-NEXT:    li a4, 5
; CHECK-NEXT:    esp.vldbc.16.ip q7, a1, -448
; CHECK-NEXT:    li a1, 0
; CHECK-NEXT:    esp.vldbc.16.xp q3, a4, s0
; CHECK-NEXT:    li a4, 12
; CHECK-NEXT:    esp.vldbc.32.ip q3, a1, 220
; CHECK-NEXT:    li a1, 12
; CHECK-NEXT:    esp.vldbc.32.xp q7, a4, a5
; CHECK-NEXT:    li a4, 4
; CHECK-NEXT:    esp.vldbc.8.ip q2, a1, 396
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.vldbc.8.xp q7, a4, s0
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    esp.vldext.s16.ip q7, q4, a1, 16
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    esp.vldext.s16.xp q5, q0, a4, a3
; CHECK-NEXT:    li a4, 3
; CHECK-NEXT:    esp.vldext.s8.ip q3, q6, a1, 80
; CHECK-NEXT:    li a1, 14
; CHECK-NEXT:    esp.vldext.s8.xp q1, q1, a4, a2
; CHECK-NEXT:    li a4, 7
; CHECK-NEXT:    esp.vldext.u16.ip q2, q5, a1, 48
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.vldext.u16.xp q2, q0, a4, s9
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.vldext.u8.ip q7, q2, a1, 64
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    esp.vldext.u8.xp q7, q2, a4, a4
; CHECK-NEXT:    li a4, 6
; CHECK-NEXT:    esp.vldhbc.16.incp q4, q7, a1
; CHECK-NEXT:    li a1, 5
; CHECK-NEXT:    esp.ld.qacc.h.h.128.ip a4, 512
; CHECK-NEXT:    li a4, 10
; CHECK-NEXT:    esp.ld.qacc.h.l.128.ip a1, -784
; CHECK-NEXT:    li a1, 10
; CHECK-NEXT:    esp.ld.qacc.l.h.128.ip a4, -800
; CHECK-NEXT:    li a4, 8
; CHECK-NEXT:    esp.ld.qacc.l.l.128.ip a1, -1952
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.ld.ua.state.ip a4, -752
; CHECK-NEXT:    li a4, 8
; CHECK-NEXT:    esp.ldxq.32 q7, q4, a0, 2, 4
; CHECK-NEXT:    esp.st.qacc.h.h.128.ip a1, -336
; CHECK-NEXT:    li a1, 4
; CHECK-NEXT:    esp.st.qacc.h.l.128.ip a4, 1568
; CHECK-NEXT:    li a4, 8
; CHECK-NEXT:    esp.st.qacc.l.h.128.ip a1, 16
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.st.qacc.l.l.128.ip a4, 416
; CHECK-NEXT:    li a4, 8
; CHECK-NEXT:    esp.st.ua.state.ip a1, -1360
; CHECK-NEXT:    li a1, 7
; CHECK-NEXT:    esp.stxq.32 q0, q6, a2, 2, 5
; CHECK-NEXT:    esp.vld.128.ip q3, a4, 784
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    esp.vld.128.xp q3, a1, s0
; CHECK-NEXT:    li a1, 6
; CHECK-NEXT:    esp.vld.h.64.ip q0, a4, -352
; CHECK-NEXT:    li s11, 6
; CHECK-NEXT:    esp.vld.h.64.xp q2, a5, s8
; CHECK-NEXT:    li a5, 13
; CHECK-NEXT:    esp.vld.l.64.ip q2, a1, 56
; CHECK-NEXT:    esp.vld.l.64.xp q5, s0, s10
; CHECK-NEXT:    li a1, 3
; CHECK-NEXT:    li s0, 3
; CHECK-NEXT:    li a4, 12
; CHECK-NEXT:    esp.vst.128.ip q5, s11, -960
; CHECK-NEXT:    esp.vst.128.xp q6, a5, t3
; CHECK-NEXT:    esp.vst.h.64.ip q7, s1, 944
; CHECK-NEXT:    esp.vst.h.64.xp q7, t3, t4
; CHECK-NEXT:    esp.vst.l.64.ip q5, a1, 984
; CHECK-NEXT:    esp.vst.l.64.xp q5, s0, s9
; CHECK-NEXT:    esp.slci.2q q1, q5, 12
; CHECK-NEXT:    esp.slcxxp.2q q2, q3, t6, t6
; CHECK-NEXT:    esp.src.q q2, q1, q3
; CHECK-NEXT:    esp.src.q.ld.ip q0, a0, -272, q5, q5
; CHECK-NEXT:    esp.src.q.ld.xp q1, a4, t5, q7, q6
; CHECK-NEXT:    li a0, 12
; CHECK-NEXT:    esp.src.q.qup q3, q7, q4
; CHECK-NEXT:    esp.srci.2q q2, q3, 7
; CHECK-NEXT:    esp.srcmb.s16.q.qacc q2, q4, 0
; CHECK-NEXT:    li a1, 13
; CHECK-NEXT:    esp.srcmb.s16.qacc q5, a1, 1
; CHECK-NEXT:    esp.srcmb.s8.q.qacc q5, q4, 0
; CHECK-NEXT:    esp.srcmb.s8.qacc q1, a3, 1
; CHECK-NEXT:    esp.srcmb.u16.q.qacc q0, q3, 1
; CHECK-NEXT:    esp.srcmb.u16.qacc q7, a1, 0
; CHECK-NEXT:    esp.srcmb.u8.q.qacc q3, q5, 1
; CHECK-NEXT:    esp.srcmb.u8.qacc q0, t6, 0
; CHECK-NEXT:    esp.srcq.128.st.incp q0, q5, a0
; CHECK-NEXT:    esp.srcxxp.2q q4, q6, s9, a2
; CHECK-NEXT:    esp.srs.s.xacc a0, a2
; CHECK-NEXT:    esp.srs.u.xacc a0, t5
...
; CHECK-NEXT:    esp.st.s.xacc.ip a3, 80
; CHECK-NEXT:    esp.st.u.xacc.ip a2, -464
