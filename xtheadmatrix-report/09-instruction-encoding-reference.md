...
## CSR Encodings
```
csrr a0, th.xmcsr    [0x73,0x25,0x20,0x80]  (addr=0x802)
csrr a0, th.mtilem   [0x73,0x25,0x30,0x80]  (addr=0x803)
csrr a0, th.mtilen   [0x73,0x25,0x40,0x80]  (addr=0x804)
csrr a0, th.mtilek   [0x73,0x25,0x50,0x80]  (addr=0x805)
csrr a0, th.xmxrm    [0x73,0x25,0x60,0x80]  (addr=0x806)
csrr a0, th.xmsat    [0x73,0x25,0x70,0x80]  (addr=0x807)
csrr a0, th.xmfflags [0x73,0x25,0x80,0x80]  (addr=0x808)
csrr a0, th.xmfrm    [0x73,0x25,0x90,0x80]  (addr=0x809)
csrr a0, th.xmsaten  [0x73,0x25,0xa0,0x80]  (addr=0x80a)
